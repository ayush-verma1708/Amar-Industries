    ...
    <div>
      ...
      {/* <section className='h-96 bg-gray-200'>
        <div className='w-full h-full flex justify-center items-center'>
          <img
            src='https://maps.googleapis.com/maps/api/staticmap?center=26.2183,78.1825&zoom=15&size=600x400&markers=color:red%7Clabel:%7C26.2183,78.1825&key=YOUR_GOOGLE_MAPS_API_KEY'
            alt='Location Map'
